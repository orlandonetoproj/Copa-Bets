...
export async function GET() {
  ...
  const url = `https://api.the-odds-api.com/v4/sports/soccer_fifa_world_cup/odds/?apiKey=${apiKey}&regions=eu,us,uk,us2&markets=h2h,totals,btts,corners&oddsFormat=decimal`;
